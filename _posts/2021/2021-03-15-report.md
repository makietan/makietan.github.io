...
<label for="アクセル・アルマー"><input type="checkbox" id="アクセル・アルマー">アクセル・アルマー</label>

<label for="パックマン"><input type="checkbox" id="パックマン">パックマン</label>
...
<label for="張五飛"><input type="checkbox" id="張五飛">張五飛</label>

<label for="エッジ・セインクラウス"><input type="checkbox" id="エッジ・セインクラウス">エッジ・セインクラウス</label>

<label for="ビッグボルフォッグ"><input type="checkbox" id="ビッグボルフォッグ">ビッグボルフォッグ</label>
...
<label for="蒼斧蛍汰"><input type="checkbox" id="蒼斧蛍汰">蒼斧蛍汰</label>
